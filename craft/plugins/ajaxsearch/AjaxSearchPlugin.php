<?php
/**
 * Ajax Search plugin for Craft CMS
 *
...
class AjaxSearchPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('A simple ajax search plugin');
    }
    ...
    {
        return 'https://github.com/helleholmsen/ajaxsearch/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/helleholmsen/ajaxsearch/master/releases.json';
    }
    ...
    {
        return 'https://github.com/helleholmsen';
    }
